(function () {
  ...
  function initSalesPerformanceChart() {
    const d = window.salesPerformanceChart || {};
    ...
    new Chart(el, {
      ...
      data: {
        labels,
        datasets: [
          lineDataset('Net Sale', d.net, '#1a73e8', { fill: true, bold: true }),
          lineDataset('Gross Sale', d.gross, '#34a853'),
          lineDataset('Returns', d.returns, '#ea4335'),
