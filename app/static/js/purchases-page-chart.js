(function () {
  ...
  function initPurchasesPerformanceChart() {
    const d = window.purchasesPerformanceChart || {};
    const el = document.getElementById('purchasesPerformanceChart');
    ...
    new Chart(el, {
      ...
      data: {
        labels,
        datasets: [
          lineDataset('Total Purchasing', d.total, '#1a73e8', { fill: true, bold: true, order: 1 }),
